...
const translations = {
  ru: {
    ...
    "demo.proto.note": "Замените ссылку на ваш реальный прототип (Figma, staging или production URL).",
  ...
  uz: {
    ...
    "demo.proto.note": "Havolani haqiqiy prototipingiz bilan almashtiring (Figma, staging yoki production URL).",
  ...
  en: {
    ...
    "demo.proto.note": "Replace this link with your real prototype (Figma, staging, or production URL).",
